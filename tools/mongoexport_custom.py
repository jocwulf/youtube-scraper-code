...
def print_usage():
    print ('python3 mongoexportcsv_custom.py "mongodb://username:password@domain:port "db-name" "table-name" "filter (e.g. {\\"_id\":\\"q05nK_EwqiQ\\"} or {} for all database entries)"')
